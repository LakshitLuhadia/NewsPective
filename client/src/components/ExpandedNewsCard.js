...
//     setPodcastLoading(true); // Set loading state
//     try {
...
//     } finally {
//         setPodcastLoading(false); // Reset loading state only after completion
//     }
// };
...
//                             Controls: Play/Pause, Forward/Rewind available in player
//                         </Typography>
//                     </Box>
//                 </Box>
//             )} */}
...
//                     onClick={handleGeneratePodcast}
//                     disabled={podcastLoading}
//                     startIcon={podcastLoading ? <CircularProgress size={20} sx={{ color: 'white' }} /> : <HeadphonesIcon />}
//                     sx={{
//                       borderRadius: '25px',
//                       mt: 2,
//                       backgroundColor: '#1a1a1a',
